...
namespace GameMain
{
    public static class ColorUtils
    {
        ...
        public static string ToColor(this string str, string color)
        {
            ...
            return GameFramework.Utility.Text.Format("<color=#{0}>{1}</color>", color, str);
        }
    }
    ...
    public static class TLogger
    {
        public static void LogAssert(bool condition, string logStr = "")
        {
            if (!condition)
            {
                ...
                {
                    logStr = GameFramework.Utility.Text.Format("{0}", "Assert Failed");
                }
                Log(LogLevel.ASSERT, logStr);
            }
        }
        ...
        public static void LogAssert(bool condition, string format, params System.Object[] args)
        {
            if (!condition)
            {
                string logStr = GameFramework.Utility.Text.Format(format, args);
                Log(LogLevel.ASSERT, logStr);
            }
        }
        ...
        {
            string msg = GameFramework.Utility.Text.Format(format, args);
        ...
        public static bool UseSystemColor = true;
