...
public static class GameModule
{
    ...
    /// 获取LuBan数据表组件。
    /// </summary>
    public static LuBanDataTableComponent DataTable { get; private set; }
