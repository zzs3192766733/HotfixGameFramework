...
using System;
using System.IO;
using BindData = UGFExtensions.ComponentAutoBindTool.BindData;

namespace UGFExtensions.UGUIExtension.Editor
{
    ...
    public class ComponentAutoBindToolInspector : UnityEditor.Editor
    {
        ...
        {
            m_BindDatas.ClearArray();
            Transform[] childs = ((ComponentAutoBindTool)target).gameObject.GetComponentsInChildren<Transform>(true);
