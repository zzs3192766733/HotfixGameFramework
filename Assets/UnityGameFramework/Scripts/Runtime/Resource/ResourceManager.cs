...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceManager : GameFrameworkModule,IResourceManager
    {
        ...
        /// <typeparam name="TObject">资源类型</typeparam>
        /// <param name="location">资源的定位地址</param>
        public AssetOperationHandle LoadAssetAsyncGetOperation<TObject>(string location) where TObject : UnityEngine.Object
        {
        ...
        public ResourcePackage GetCurrResourcePackage()
        {
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks, object userData = null)
        {
            ...
            UnloadSceneCo(sceneAssetName, unloadSceneCallbacks, userData).ToUniTask().Forget();
            //Utility.Unity.StartCoroutine();
        }
