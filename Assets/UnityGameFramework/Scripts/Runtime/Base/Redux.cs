...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class AbsGameModuleMgr<T> : Singleton<T>, IGameModule where T : AbsGameModuleMgr<T>, new()
    {
        ...
        {
            Init();
            OnRegisterPatch?.Invoke(Instance);
        ...
        public void RegisterSystem<TSystem>(TSystem system) where TSystem : ISystem
        {
            ...
            mContainer.RegisterSystem(system);
        ...
        public void RegisterModel<TModel>(TModel model) where TModel : IModel
        {
            ...
            mContainer.RegisterModel(model);
        ...
        {
            mContainer.RegisterUtility(utility);
        }

        public TSystem GetSystem<TSystem>() where TSystem : class, ISystem
        {
            return mContainer.GetSystem<TSystem>();
        }

        public TModel GetModel<TModel>() where TModel : class, IModel
        {
            return mContainer.GetModel<TModel>();
        }

        public TUtility GetUtility<TUtility>() where TUtility : class, IUtility
        {
            return mContainer.GetUtility<TUtility>();
        }
    ...
    public interface ISystem : IBelongToGameModule, ICanSetGameModule, ICanGetModel, ICanGetUtility,
        ICanRegisterEvent, ICanSendEvent, ICanGetSystem, ICanSendCommand,IDisposable
    {
        void Init();
    }
    ...
    public interface IModel : IBelongToGameModule, ICanSetGameModule, ICanGetUtility, ICanSendEvent,IDisposable
    {
        void Init();
    }
    ...
    {
        private Dictionary<Type, ISystem> mSystemDic = new Dictionary<Type, ISystem>();
        private Dictionary<Type, IModel> mModelDic = new Dictionary<Type, IModel>();
        private Dictionary<Type, IUtility> mUtilityDic = new Dictionary<Type, IUtility>();

        public void RegisterSystem<T>(T instance) where T : ISystem
        {
            var key = typeof(T);

            if (mSystemDic.ContainsKey(key))
            {
                mSystemDic[key] = instance;
            }
            else
            {
                mSystemDic.Add(key, instance);
            }
        }
        ...
        public void RegisterModel<T>(T instance) where T : IModel
        {
            ...
            if (mModelDic.ContainsKey(key))
            {
                mModelDic[key] = instance;
            }
            else
            {
                mModelDic.Add(key, instance);
            }
        }
        ...
        public void RegisterUtility<T>(T instance) where T : IUtility
        {
            ...
            if (mUtilityDic.ContainsKey(key))
            {
                mUtilityDic[key] = instance;
            }
            else
            {
                mUtilityDic.Add(key, instance);
            }
        }
        ...
        public T GetSystem<T>() where T : class
        {
            ...
            if (mSystemDic.TryGetValue(key, out var retInstance))
            {
        ...
        public T GetModel<T>() where T : class
        {
            ...
            if (mModelDic.TryGetValue(key, out var retInstance))
            {
                return retInstance as T;
            }
        ...
        public T GetUtility<T>() where T : class
        {
            ...
            if (mUtilityDic.TryGetValue(key, out var retInstance))
            {
                return retInstance as T;
            }
        ...
        public void Dispose()
        {
            foreach (var item in mSystemDic.Values)
                item.Dispose();
            foreach (var item in mModelDic.Values)
                item.Dispose();
            foreach (var item in mUtilityDic.Values)
                item.Dispose();
            mSystemDic.Clear();
            mModelDic.Clear();
            mUtilityDic.Clear();
