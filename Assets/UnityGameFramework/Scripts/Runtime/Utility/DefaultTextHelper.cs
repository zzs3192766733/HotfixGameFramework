...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultTextHelper : Utility.Text.ITextHelper
    {
        ...
        public string AppendFormat<T1>(string format, T1 arg1)
        {
            if (format == null)
            {
                throw new GameFrameworkException("Format is invalid.");
            ...
            CheckCachedStringBuilder();
            s_CachedStringBuilder.Length = 0;
            s_CachedStringBuilder.AppendFormat(format, arg1);
            return s_CachedStringBuilder.ToString();
        }

        public string AppendFormat<T1, T2>(string format, T1 arg1, T2 arg2)
        {
            if (format == null)
            {
                throw new GameFrameworkException("Format is invalid.");
        ...
        public string AppendFormat<T1, T2, T3>(string format, T1 arg1, T2 arg2, T3 arg3)
        {
            if (format == null)
            {
                throw new GameFrameworkException("Format is invalid.");
