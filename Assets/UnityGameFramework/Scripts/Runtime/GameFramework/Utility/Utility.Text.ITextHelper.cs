    ...
    public static partial class Utility
    {
        public static partial class Text
        {
            ...
            public interface ITextHelper
            {
                ...
                string AppendFormat<T1>(string format, T1 arg1);
                string AppendFormat<T1, T2>(string format, T1 arg1, T2 arg2);
                string AppendFormat<T1, T2, T3>(string format, T1 arg1, T2 arg2, T3 arg3);
            }
        }
    }
}
