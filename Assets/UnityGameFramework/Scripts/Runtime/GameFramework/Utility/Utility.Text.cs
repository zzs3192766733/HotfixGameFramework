namespace GameFramework
{
    public static partial class Utility
    {
        ...
        public static partial class Text
        {
            ...
            public static string AppendFormat<T1>(string format, T1 arg1)
            {
                if (format == null)
                {
                    throw new GameFrameworkException("Format is invalid.");
                ...
                if (s_TextHelper == null)
                {
                    throw new GameFrameworkException("Not set TextHelper.");
                }

                return s_TextHelper.AppendFormat(format, arg1);
            }

            public static string AppendFormat<T1,T2>(string format, T1 arg1,T2 arg2)
            {
                if (format == null)
                {
                    throw new GameFrameworkException("Format is invalid.");
                ...
                return s_TextHelper.AppendFormat(format, arg1, arg2);
            }

            public static string AppendFormat<T1,T2,T3>(string format, T1 arg1,T2 arg2,T3 arg3)
            {
                if (format == null)
                {
                    throw new GameFrameworkException("Format is invalid.");
                ...
                return s_TextHelper.AppendFormat(format, arg1, arg2, arg3);
            }
        }
    }
}
